...
/**
 * Deprecated. Use filter(entry, stat) to filter dirs/files/etc.
 *
...
/**
 *
 * Setup a function to filter out entries.
 *
 * @param fn {Function} a function that will be given a stat name, which
 * if returns true will include the stat and it's children
 */
